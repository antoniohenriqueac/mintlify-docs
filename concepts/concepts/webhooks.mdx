---
title: 'Webhooks'
description: 'Entenda como funcionam os webhooks e notificações automáticas no ConnectVets Notes'
---
...
sequenceDiagram
    ...
    Note over App: Aplicação atualiza<br/>interface automaticamente
```
